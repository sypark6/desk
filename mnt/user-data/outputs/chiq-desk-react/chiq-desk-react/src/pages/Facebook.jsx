...
const TABS = ['Posts', 'Reels', 'DMs']

export default function Facebook() {
  const { comments, approveComment } = useWorkspace()
  const [activeTab, setActiveTab] = useState('Posts')

  const platformComments = comments.filter(c => c.platform === 'fb')
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="p-7 flex-1">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-5
                        text-[13px] text-blue-800">
          💡 <strong>Tone Guide:</strong> Posts: balanced, on-brand. Reels: casual + upbeat.
          DMs: personal, warm, always offer resolution.
        </div>
